...
{{< figure src="NKNT-20160106-location.jpg" caption="（左）朝鲜2016年核爆定位位置（五角星标记为2016/01/06)相对于其2013 年核爆位置 (五角星标记为 2013/02/12)，及其定位误差（椭圆）。（右）Google地图中朝鲜2016年及其历次核爆的位置（红圈），引爆时刻（红标志）和当量（蓝标志）">}}
 ...
 {{< figure src="NKNT-20160106-waveforms.jpg" caption="朝鲜四次核爆的地点（红色五角星），用于该研究的地震台站分布（三角形）以及2013和2016年两次核爆的地震波波形。">}}
